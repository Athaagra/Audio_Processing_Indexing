% Read the soundwave
% Note that this is a soundwave with 
% Number of Channels: 1
% Sample rate:        16kHz
% Resolution:         16 bits
% Signed:             yes
% Length:             30 seconds => 480000 samples
% Amplitude:          0.5FSV (i.e. values from the interval (-16384, 16384)
...
[y,fs,wmode,fidx]=readwav('1000hz_square.wav','r',-1,0);
